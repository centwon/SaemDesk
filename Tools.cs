...
{
    public object Convert(object? sourceValue, Type targetType, object? parameter, System.Globalization.CultureInfo culture)
    {
    ...
    public object? ConvertBack(object? sourceValue, Type targetType, object? parameter, System.Globalization.CultureInfo culture)
    {
        string date = (string)(sourceValue ?? string.Empty);
        if (date.Contains("오늘"))
        {
