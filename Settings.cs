...
public static class Settings
{
    ...
    public static bool IsPortableMode { get; } = !UserDataPath.Equals(
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "SaemDesk"),
    ...
    private static string ResolveDataPath()
    {
        ...
        var userPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "SaemDesk");
    ...
    private static void LoadAll()
    {
        ...
        ProvinceName.Reload();
        // NeisApiKey 는 빌드 시 secrets.props 로만 주입 — DB persistence 사용 안 함
    ...
    private const string AppRegistryName = "SaemDesk";
