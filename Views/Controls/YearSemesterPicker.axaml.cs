...
/// </summary>
public partial class YearSemesterPicker : UserControl
{
    // ── 상태 ────────────────────────────────────────────
    ...
    private void OnSemesterChanged(object? sender, SelectionChangedEventArgs e)
    {
        if (!_initialized || _updating) return;
        RaiseChanged();
    }
