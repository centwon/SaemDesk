...
/// NewSchool LessonLogEditDialog MVP 포팅 — Course 사전 선택 / 단원 선택은 단순 텍스트로 대체.
/// </summary>
public partial class LessonLogEditDialog : Window
{
    ...
    private async void OnSave(object? sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            int period = 1;
            if (CBoxPeriod.SelectedItem is ComboBoxItem pi && int.TryParse(pi.Tag?.ToString(), out var p))
                period = p;
